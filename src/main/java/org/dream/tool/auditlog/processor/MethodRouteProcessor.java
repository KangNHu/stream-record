...
import org.dream.tool.auditlog.matedata.DefaultLogDefinition;
import org.springframework.util.ReflectionUtils;

import java.lang.reflect.Method;

import static org.dream.tool.auditlog.matedata.DefaultLogDefinition.ROUTE_METHOD_PARAM_TYPES;
...
public class MethodRouteProcessor implements Processor {
	...
	private void invokeRouteMethod(DefaultLogDefinition logDefinition , CurrentContext currentContext) {
		...
		Class[] paramTypes = (Class[])logDefinition.get(ROUTE_METHOD_PARAM_TYPES);
		...
		if (value == null){
			...
			attributeAccess.put(AuditLogInfo.MASSAGE_ATTR , value.toString());
		}
	}
