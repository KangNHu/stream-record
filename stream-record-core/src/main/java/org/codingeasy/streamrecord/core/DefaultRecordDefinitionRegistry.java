...
* @author : KangNing Hu
*/
public class DefaultRecordDefinitionRegistry extends ReadWriteLock implements RecordDefinitionRegistry {


	/**
	 * key -> record定义
	 */
	private Map<String , RecordDefinition> recordDefinitionMap = new HashMap<String, RecordDefinition>(16);
	...
	public void register(RecordDefinition recordDefinition) {
		writeExecute(() -> {
			String cacheKey = buildCacheKey(recordDefinition.getMethod() , recordDefinition.getTargetClass());
