...
public class ParamNodeTest {
  ...
  public void parseParams() {
    RecordDefinitionBuilder recordDefinitionBuilder = new RecordDefinitionBuilder(
        ReflectionUtils.findMethod(ParamNodeTest.class, "log", User.class), ParamNodeTest.class);
