...
public class DefaultParamParseTest {
  ...
  class TestReflectiveMethodInvocation extends ReflectiveMethodInvocation {
    ...
    public TestReflectiveMethodInvocation(Object target, Method method, Object[] arguments,
        Class<?> targetClass) {
  ...
  public void parse() {
    ...
    ReflectiveMethodInvocation reflectiveMethodInvocation = new TestReflectiveMethodInvocation(
        userService, method, new Object[]{user},
        UserServiceImpl.class);
    CurrentContext currentContext = new CurrentContext(defaultLogDefinitionRegistry,
        attributeAccess, new InterceptMethodWrapper(reflectiveMethodInvocation));
